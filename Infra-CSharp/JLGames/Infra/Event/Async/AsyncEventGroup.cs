...
// {
//     public sealed class AsyncEventGroup
//     {
//         private struct EventItem
//         {
//             public string Tag;
//             public EventDelegates.AsyncEventHandler Handler;
//             public int Weight;
//             public uint Remain;
//         }
//
...
//         public async void Handle(EventData data)
//         {
...
//                 {
//                     await m_Temp[index].Handler.Invoke(data);
//                 }
//             }
//             catch (Exception)
//             {
...
//         public void AddEventHandler(EventDelegates.AsyncEventHandler handler, int weight, uint handleTimes, string tag)
//         {
...
//         /// <param name="handler"></param>
//         /// <param name="tag"></param>
//         public void RemoveEventHandler(EventDelegates.AsyncEventHandler handler, string tag)
//         {
