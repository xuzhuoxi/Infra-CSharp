...
{
    /// <summary>
    /// <see cref="IConnectAdapter"/> using <see cref="Socket.ConnectAsync"/> / <see cref="Socket.DisconnectAsync"/> (TAP).
    /// 基于 <see cref="Socket.ConnectAsync"/> / <see cref="Socket.DisconnectAsync"/> 的连接适配器（TAP）。
    /// </summary>
